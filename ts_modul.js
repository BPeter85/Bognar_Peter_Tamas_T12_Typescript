...
function feltoltoObjektum(tombElem) {
    var beolvasottAdatok = [];
    for (var i = 0; i < tombElem.length; i++) {
        var elemDarabok = tombElem[i].split(";");
        var objektum = {
...
var snookerAdatok = feltoltoObjektum(snookerInfo);
//1.Feladat
...
function LeetKod(vizsgaltSzoveg) {
    var maganhangzok = ["a", "A"];
    var maganhangzok2 = ["o", "O"];
    var maganhangzok3 = ["i", "I"];
    var maganhangzok4 = ["e", "E"];
    var modositottSzo = "";
    var modositottSzo2 = "";
    var modositottSzo3 = "";
    var modositottSzo4 = "";
    for (var i = 0; i < vizsgaltSzoveg.length; i++) {
        var csereVizsgalo = false;
    ...
    for (var i = 0; i < modositottSzo.length; i++) {
        var csereVizsgalo = false;
        for (var j = 0; j < maganhangzok2.length; j++) {
    ...
    for (var i = 0; i < modositottSzo2.length; i++) {
        var csereVizsgalo = false;
        for (var j = 0; j < maganhangzok3.length; j++) {
    ...
    for (var i = 0; i < modositottSzo3.length; i++) {
        var csereVizsgalo = false;
        for (var j = 0; j < maganhangzok4.length; j++) {
